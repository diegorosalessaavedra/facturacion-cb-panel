  ...
  exportToExcel(
    ...
    productos.forEach((producto) => {
      ...
      transactions.forEach((item, index) => {
        ...
        let tipoOperacion = "-";
        let docRefId = "-";
        const codUnidad = item.codUnidad === "NIU" ? "07" : "01";
        ...
        if (item.type === "compra" || item.type === "nota") {
          ...
          const precioUnitario =
            (Number(item.precioUnitario || 0) + 0.05) / 1.18;
          ...
          tipoCompNum =
            TIPO_COMPROBANTE_VENTAS.find(
              (c) =>
                c.descripcion ===
                item.cotizacion.ComprobanteElectronico?.tipoCom
            )?.numero ?? "-";
        ...
        rowData[9] = { v: cantidadEntrada, s: numberStyle5Decimal };
        rowData[10] = { v: puEntrada, s: numberStyle5Decimal };
        rowData[11] = { v: ptEntrada, s: numberStyle5Decimal };
        rowData[12] = { v: cantidadSalida, s: negativeNumberStyle5Decimal };
        rowData[13] = { v: puSalida, s: negativeNumberStyle5Decimal };
        rowData[14] = { v: ptSalida, s: negativeNumberStyle5Decimal };
        rowData[15] = { v: saldoCantidad.toFixed(5), s: numberStyle5Decimal };
        rowData[16] = {
