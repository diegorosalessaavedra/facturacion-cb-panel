...
import DatosPesonalesColaborador from "./components/DatosPesonalesColaborador";
import EducacionCargoLaboral from "./components/EducacionCargoLaboral";
...
const ModalNuevoColaborador = ({
  ...
  // Función para agregar un nuevo par de campos de archivo complementario
