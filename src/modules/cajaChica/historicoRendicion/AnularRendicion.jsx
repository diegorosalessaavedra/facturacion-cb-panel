...
const AnularRendicion = () => {
  ...
  const handleRemoveRendicion = async () => {
    setLoading(true);
    ...
    try {
      ...
      // Usamos res.data.rendicion (o res.data según cómo lo devuelva tu backend)
  ...
  useEffect(() => {
    if (isSuccess && countdown > 0) {
      ...
      navigate("/caja-chica/rendiciones"); // Redirigir a la vista de rendiciones
    }
        ...
        {!isSuccess ? (
          ...
          <div className="p-8 flex flex-col items-center text-center gap-4">
            ...
            <p className="text-sm text-slate-500 mb-4">
              Estás a punto de anular esta rendición de caja chica. Esta acción
            ...
            {rendicion && (
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-4 w-full text-left mt-2 mb-4">
                ...
                <p className="text-sm text-slate-700">
                  ...
                  {rendicion.concepto_rendicion || "N/A"}
                </p>
                <p className="text-sm text-slate-700">
                  <span className="font-semibold">Total Gastos:</span> S/{" "}
                  {rendicion.total_gastos || "0.00"}
                </p>
              </div>
            )}
...
export default AnularRendicion;
