...
import BanerComprobanteOrdenCompra from "./components/BanerComprobanteOrdenCompra";

const ComprobanteOrdenCompra = ({ userData }) => {
  const { id } = useParams();
...
export default ComprobanteOrdenCompra;
