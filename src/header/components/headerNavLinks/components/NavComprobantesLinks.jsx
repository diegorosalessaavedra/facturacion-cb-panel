...
const NavComprobantesLinks = ({
  ...
  const isOpen = openListModule === "comprobantes";

  // Arreglo de rutas para un código limpio y profesional
  const menuLinks = [
    {
      to: "/comprobantes/comprobante-electronico",
      label: "Emitir comprobantes de venta sin cotización",
    },
    {
  ...
  return (
    <div className="w-[280px] bg-slate-900 flex flex-col border-t-[0.5px] border-slate-400">
      ...
      <div
        ...
        `}
        onClick={() => {
          setOpenListModule(isOpen ? "" : "comprobantes");
        }}
      >
      ...
      <div
        ...
        style={{
          // 200px da margen suficiente por si el texto largo salta a varias líneas
      ...
      >
        <div className="flex flex-col py-2 border-l-4 border-transparent">
          {menuLinks.map((link, idx) => (
            ...
            >
              {/* Viñeta sutil que destaca al hacer hover. shrink-0 evita que se deforme */}
              ...
              {/* leading-tight es vital aquí para mantener la estética si el texto ocupa varias líneas */}
