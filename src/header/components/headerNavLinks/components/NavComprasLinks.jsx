...
const NavComprasLinks = ({
  ...
  const isOpen = openListModule === "compras";
  ...
  return (
    <div className="w-[280px] bg-slate-900 flex flex-col border-t-[0.5px] border-slate-400">
      ...
      <div
        ...
        `}
        onClick={() => {
          setOpenListModule(isOpen ? "" : "compras");
        }}
      >
      ...
      <div
        ...
        style={{
          // Con 150px es suficiente para estos 2 enlaces
      ...
      >
        <div className="flex flex-col py-2 border-l-4 border-transparent">
          {menuLinks.map((link, idx) => (
            ...
            >
              {/* Viñeta sutil que destaca al hacer hover */}
