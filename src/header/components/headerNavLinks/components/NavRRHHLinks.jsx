...
const NavRRHHLinks = ({
  openListModule,
  setOpenListModule,
  setIsMenuOpen, // Añadido para mantener el estándar y cerrar en móviles
  userData,
}) => {
  const isOpen = openListModule === "rrhh";

  // Arreglo dinámico: Los enlaces de gerente solo se añaden si cumple la condición
  const menuLinks = [
  ...
  return (
    <div className="w-[280px] bg-slate-900 flex flex-col border-t-[0.5px] border-slate-400">
      ...
      <div
        ...
        style={{
          // 400px es suficiente en caso de que sea GERENTE y se rendericen todos los enlaces
